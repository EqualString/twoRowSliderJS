// generated on 2017-02-15 using generator-webapp 2.4.1
...
gulp.task('html', ['styles', 'scripts'], () => {
  return gulp.src('test/*.html')
    .pipe($.useref({searchPath: ['.tmp', 'test', '.']}))
...
gulp.task('serve', () => {
  runSequence(['clean', 'wiredep'], ['styles', 'scripts', 'fonts'], () => {
    ...
    gulp.watch('test/scripts/**/*.js', ['scripts']);
    gulp.watch('test/fonts/**/*', ['fonts']);
